...
import IcCities from '../../assets/images/icon-cities.svg';
import IcTraveler from '../../assets/images/icon-traveler.svg';
import IcTreasure from '../../assets/images/icon-treasure.svg';
           ...
           <div className="row align-items-center">
            ...
            <div className="col-6 pl-5">
                <div style={{width: 520, height: 410}}>
                    <img src={ImageHero} alt="Room" className="img-fluid position-absolute" style={{margin: '-30px 0 0 -30px', zIndex: 1}}/>
                    <img src={ImageHero_} alt="Room Frames" className="img-fluid position-absolute" style={{margin: '0 -15px -15px 0'}}/>
                </div>
            </div>
           </div>
       </section>
